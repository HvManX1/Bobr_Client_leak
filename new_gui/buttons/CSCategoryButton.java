...
extends CSButton {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (CatClient.csgui.currentCategory == this) {
lbl5:
            // 2 sources

            v0 = CatClient.getClientColor().getRGB();
        } else {
            v0 = this.color;
        }
        color = v0;
        ...
        while (true) {
            ...
            csm = var5_5.next();
            if (CatClient.csgui.currentCategory != this) continue;
    ...
    public void initButton() {
        ...
        int x = this.x + 65;
        int y = 110;
        for (int i = 0; i < CatClient.instance.moduleManager.modules.size(); ++i) {
            Module m = CatClient.instance.moduleManager.modules.get(i);
    ...
    private boolean isCurrentPanel() {
        return CatClient.csgui.currentCategory == this;
    }
}
