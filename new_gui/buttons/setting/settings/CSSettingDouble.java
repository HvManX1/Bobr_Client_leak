...
extends CSSetting {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.mc.fontRenderer.drawString("<", this.x + 1, this.y + 1, this.isHoveredLeft(mouseX, mouseY) ? CatClient.getClientColor().getRGB() : Integer.MAX_VALUE);
        this.mc.fontRenderer.drawString(">", this.x + 1 + this.fr.getStringWidth(this.set.getName() + " " + round) + 15, this.y + 1, this.isHoveredRight(mouseX, mouseY) ? CatClient.getClientColor().getRGB() : Integer.MAX_VALUE);
