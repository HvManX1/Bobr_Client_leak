...
public class ModuleButton {
    ...
    public ModuleButton(Module ifunc, Panel pl) {
        ...
        if (CatClient.instance.settingsManager.getSettingsByMod(ifunc) != null) {
            for (Setting setting : CatClient.instance.settingsManager.getSettingsByMod(ifunc)) {
                if (setting.isCheck()) {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (CatClient.instance.settingsManager.getSettingsByMod(this.func) != null) {
            GL11.glPushMatrix();
