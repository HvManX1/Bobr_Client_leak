            ...
            try {
                ...
                block27: {
                    block26: {
                        ...
                        if (entity == null || !(entity instanceof EntityPlayer)) break block25;
                        ...
                        if (!this.useCooldown.getValue() ? cps == 0.0f || (double)(System.currentTimeMillis() - this.time) < 1000.0 / (double)cps : Minecraft.getMinecraft().player.getCooledAttackStrength(0.0f) < 1.0f) break block26;
