...
extends Module {
    public ShkafRender() {
        ...
        CatClient.instance.settingsManager.rSetting(new Setting("Wallhack", this, false));
        CatClient.instance.settingsManager.rSetting(new Setting("Glowing", this, true));
    }
    ...
    public void onRenderWorld(RenderWorldLastEvent event) {
        ...
        boolean Wallhack = CatClient.instance.settingsManager.getSettingByName(this, "Wallhack").getValBoolean();
        boolean Glowing = CatClient.instance.settingsManager.getSettingByName(this, "Glowing").getValBoolean();
