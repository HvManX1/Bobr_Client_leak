...
extends Module {
    ...
    public void onRenderWorld(RenderWorldLastEvent event) {
        for (Entity e : NameTags.mc.world.loadedEntityList) {
            ...
            Gui.drawRect((int)(-NameTags.mc.fontRenderer.getStringWidth(e.getName() + " " + health + "%") / 2 - 2), (int)-2, (int)(NameTags.mc.fontRenderer.getStringWidth(e.getName()) / 2 + 16), (int)10, (int)Integer.MIN_VALUE);
