...
extends Module {
    ...
    public cartridgesHUD() {
        ...
        this.GUNPOWDER = 0;
        this.ARROW = 0;
        CatClient.instance.settingsManager.rSetting(new Setting("TargetHudX", this, 0.0, -200.0, 200.0, true));
        CatClient.instance.settingsManager.rSetting(new Setting("TargetHudY", this, 0.0, -200.0, 200.0, true));
    }
