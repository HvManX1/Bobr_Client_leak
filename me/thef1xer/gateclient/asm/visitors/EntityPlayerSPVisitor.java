...
extends ClassVisitor {
    ...
    extends MethodVisitor {
        ...
        public void visitCode() {
            super.visitCode();
            this.mv.visitMethodInsn(184, "me/thef1xer/gateclient/util/EventFactory", "onUpdateWalkingPlayer", "()Z", false);
            Label l1 = new Label();
    ...
    extends MethodVisitor {
        ...
        public void visitCode() {
            this.mv.visitTypeInsn(187, "me/thef1xer/gateclient/events/PlayerMoveEvent");
            this.mv.visitInsn(89);
            this.mv.visitVarInsn(24, 2);
            this.mv.visitVarInsn(24, 4);
            this.mv.visitVarInsn(24, 6);
            this.mv.visitMethodInsn(183, "me/thef1xer/gateclient/events/PlayerMoveEvent", "<init>", "(DDD)V", false);
            ...
            this.mv.visitFrame(1, 1, new Object[]{"me/thef1xer/gateclient/events/PlayerMoveEvent"}, 0, null);
            this.mv.visitVarInsn(25, 8);
            this.mv.visitFieldInsn(180, "me/thef1xer/gateclient/events/PlayerMoveEvent", "x", "D");
            this.mv.visitVarInsn(57, 2);
            this.mv.visitVarInsn(25, 8);
            this.mv.visitFieldInsn(180, "me/thef1xer/gateclient/events/PlayerMoveEvent", "y", "D");
            this.mv.visitVarInsn(57, 4);
            this.mv.visitVarInsn(25, 8);
            this.mv.visitFieldInsn(180, "me/thef1xer/gateclient/events/PlayerMoveEvent", "z", "D");
    ...
    extends MethodVisitor {
        ...
        public void visitInsn(int opcode) {
            if (opcode == 172) {
                this.mv.visitMethodInsn(184, "me/thef1xer/gateclient/util/EventFactory", "isUser", "()Z", false);
            }
