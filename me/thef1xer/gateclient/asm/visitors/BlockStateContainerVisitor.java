    ...
    extends MethodVisitor {
        ...
        public void visitInsn(int opcode) {
            if (opcode == 174) {
                ...
                this.mv.visitMethodInsn(184, "me/thef1xer/gateclient/util/EventFactory", "getAmbientOcclusionLightValue", "(Lnet/minecraft/block/state/IBlockState;)F", false);
            }
    ...
    extends MethodVisitor {
        ...
        public void visitInsn(int opcode) {
            if (opcode == 172) {
                ...
                this.mv.visitMethodInsn(184, "me/thef1xer/gateclient/util/EventFactory", "shouldSideBeRendered", "(Lnet/minecraft/block/state/IBlockState;Lnet/minecraft/world/IBlockAccess;Lnet/minecraft/util/math/BlockPos;Lnet/minecraft/util/EnumFacing;)Z", false);
            }
            super.visitInsn(opcode);
        }
    }
